...
/**
 * Clase que contine el comportamiento de la disyuncion logica
 */

class Or : public OperacionCompuesta {
public:
    /**
     ...
     */
    Or(Formula* izq, Formula* der);
    ~Or();
    /**
     * @param mod Modelo en el que se va a evaluar la formula
     * @return true Si la disyuncion logica entre las dos formulas es valida
     */

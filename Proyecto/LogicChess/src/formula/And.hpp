...
/**
 * Clase que contine el comportamiento de la conjuncion logica
 */

class And : public OperacionCompuesta {
public:
    /**
     ...
     */
    And(Formula* izq, Formula* der);
    ~And();
    /**
     * @param mod Modelo en el que se va a evaluar la formula
     * @return true Si la conjuncion logica entre las dos formulas es valida
     */
